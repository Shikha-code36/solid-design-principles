...
These principles are especially useful as a codebase grows and different parts of the system start changing independently.
...
6. Implement the same design in C++
